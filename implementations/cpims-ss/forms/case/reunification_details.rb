FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      {
        name: "not_reunited_with_verified_adult_reason_free_response",
        visible: true,
        mobile_visible: true,
        hide_on_view_page: false,
        show_on_minify_form: false,
      ...
      {
        name: "reunification_follow_up_details",
        visible: true,
        mobile_visible: true,
        hide_on_view_page: false,
        show_on_minify_form: false,
        ...
        editable: true,
        disabled: false,
        display_name_en: "Briefly detail any follow up or support needed to support the reunification or ensure the safety of the child",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
