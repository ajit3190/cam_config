    ...
    fields_attributes: [
      ...
      },
      {
        ...
        option_strings_text_en: [
          ...
          {
            id: "moved_with_family",
            display_text: "Moved with family"
          },
          {
            id: "moved_with_another_caregiver",
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Briefly describe any observation made during the follow-up",
        help_text_en: "Include any health concerns, interaction with care-giver, etc.",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        help_text_en: "Briefly describe any actions taken and updates regarding the child and her/his situation. Include who you met/spoke with, what happened, what you learned.",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Recommendations/Further actions needed",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
