    ...
    fields_attributes: [
      {
        ...
        option_strings_source: "lookup lookup-consent-obtained-from",
        autosum_total: false,
        autosum_group: "",
        required: false
      },
      ...
      },
      {
        ...
        help_text_en: "Consent has been given for the case worker to intervene / manage the child's case.  This includes storing personal details about the parent and/or that of the child  in the case management system (paper and electronic).",
      ...
      },
      {
        ...
        help_text_en: "The child must provide consent before any services are provided",
        tick_box_label_en: "Yes",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
      ...
      {
        name: "consent_info_not_sharing_other",
        visible: false,
        mobile_visible: false,
        hide_on_view_page: false,
        show_on_minify_form: false,
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "What information should be withheld from a particular organization or individual",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
