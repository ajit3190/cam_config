FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        option_strings_text_i18n: [
          ...
          },
          {
            ...
            display_text: {
              en: "Instant message/SMS/WhatsApp"
            }
          },
          {
            id: "email",
          ...
          },
          {
            ...
            display_text: {
              en: "Ad-hoc home visit (child/family)"
            }
          },
          {
            id: "scheduled_home_visit_child_family",
            display_text: {
              en: "Scheduled home visit (child/family)"
            }
          },
          {
            id: "face_to_face_meeting_outside_of_home_child_family",
            display_text: {
              en: "Face-to-face meeting outside of home (child/family)"
            }
          },
          {
            id: "face_to_face_meeting_service_provider_and_child_family",
            display_text: {
              en: "Face-to-face meeting (service provider and child/family)"
            }
          },
          {
            id: "face_to_face_meeting_service_provider_only",
            display_text: {
              en: "Face-to-face meeting (service provider only)"
            }
          },
          {
            id: "community_based_group",
            display_text: {
              en: "Community-based group"
            }
          },
          {
            id: "authorities",
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Followed up on specific action/service from case plan?"
        },
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Specify which action/service (from case plan) followed up on or what other element followed-up on"
        },
        order: 12,
        hidden_text_field: false,
        autosum_total: false,
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Purpose of follow up"
        },
        help_text_i18n: {
          en: "Describe the reason for following-up on this specific action/service/element"
        },
        order: 13,
        hidden_text_field: false,
        autosum_total: false,
      ...
      {
        name: "followup_result_separator",
        type: "separator",
        multi_select: false,
        visible: true,
        mobile_visible: true,
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Outcome of follow up"
        },
        help_text_i18n: {
          en: "E.g. details about the action taken/service provided, the outcomes of the action taken/service provided, details about the change in the child's situation"
        },
        order: 15,
        hidden_text_field: false,
        autosum_total: false,
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "If followed up on, has the specific action/service from the case plan been conducted?"
        },
        option_strings_text_i18n: [
          {
            id: "yes",
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "If followed up on, has the situation of the child significantly changed?"
        },
        option_strings_text_i18n: [
          {
            id: "yes",
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Are there any other recommendations based on the follow-up conducted?"
        },
        order: 20,
        hidden_text_field: false,
        autosum_total: false,
