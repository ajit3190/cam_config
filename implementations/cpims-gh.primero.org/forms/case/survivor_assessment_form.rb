...
survivor_assessment_fields = [
  Field.new(name: 'assessment_emotional_state_start',
            ...
            guiding_questions: ['Is the survivor a woman, man, girl or boy or other gender identity?',
                                '',
  ...
  Field.new(name: 'assessment_family_situation',
            ...
            guiding_questions: ["Adult survivor's family situation:",
                                '',
  ...
  Field.new(name: 'assessment_presenting_problem',
            ...
            guiding_questions: ["Describe what happened to the survivor in the survivor's own words. Identify what problem(s)/concern(s)/issue(s) the survivor is requesting assistance/support for.",
                                '',
                                "List survivor's main concerns in her own words (do not suggest). These might include: immediate safety, children's safety, access to economic resources, medical assistance, perception of others, etc."].join("\n")),
  ...
  Field.new(name: 'assessment_current_situation',
            ...
            guiding_questions: ['Identify situations, circumstances and people that are continuing to harm the survivor or put her at risk of harm. ',
                                '',
                                ...
                                '',
                                'Has survivor sought help previously and/or already received care and treatment? Does survivor express any current or past suicidal thoughts? (If so, follow the Suicide Risk Assessment Protocol)'].join("\n")),
  ...
  Field.new(name: 'assessment_psychosocial_needs',
            ...
            guiding_questions: ['How does the survivor describe her emotional state?',
                                '',
  ...
  Field.new(name: 'assessment_legal_needs',
            ...
            guiding_questions: ['Does the survivor wish to report to formal authorities and/or take legal action.',
                                '',
