...
basic_identity_fields = [
  ...
  Field.new(name: 'name',
            ...
            matchable: true,
            disabled: true,
            help_text_en: 'This field will be automatically generated based on the First Name, Middle Name, and Last Name.'),
  ...
  Field.new(name: 'leap_beneficiary',
            type: 'radio_button',
            display_name_en: 'Is the client a LEAP beneficiary?',
            option_strings_source: 'lookup lookup-yes-no'),
  Field.new(name: 'active_nhis_card',
            type: 'radio_button',
            display_name_en: 'Does the client have an active NHIS card?',
            option_strings_source: 'lookup lookup-yes-no')
]
...
FormSection.create_or_update!(
  ...
  is_first_tab: true,
  name_en: "Individual's Details",
  description_en: "Individual's Details",
  mobile_form: true,
