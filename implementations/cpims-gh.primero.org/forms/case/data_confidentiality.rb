...
consent_fields = [
  ...
  Field.new(name: 'consent_for_services',
            ...
            display_name_en: 'Consent has been obtained for the client to receive case management services',
  ...
  Field.new(name: 'consent_for_tracing',
            ...
            option_strings_source: 'lookup lookup-yes-no',
            help_text: "If this field is 'No', the client's case record will not show up in Matches with Inquirer Tracing Requests.",
            visible: false,
  ...
  Field.new(name: 'disclosure_other_orgs',
            ...
            help_text: 'This includes sharing information with other organizations providing services.'),
