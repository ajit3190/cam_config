FormSection.create_or_update!(
  {
    ...
    'name_ar-LB': "Nested Verification Subform",
    'description_ar-LB': "Nested Verification Subform",
    ...
    fields_attributes: [
      {
        ...
        'display_name_ar-LB': "Inquirer's Name",
        multi_select: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "Relationship",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Do you want the child to come and live with you?",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "Are you able to care for him/her/them?",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "If not, is there any other family member who could take the child?",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "Name of alternate caregiver",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Relationship of Alternate Caregiver",
        option_strings_text_en: [
          {
            id: "mother",
            display_text: "Mother"
      ...
      },
      {
        ...
        'display_name_ar-LB': "Address of that person (alternative caregiver)",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Alternate Caregiver's Village/Area/Physical Address",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Date of acceptance to take care of child",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Does the child know the adult requesting verification?",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "Does the child wish to be reunified with that person?",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "Does the information given by the child and adult match?",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "Do you recommend reunifcation and if not what other action?",
        option_strings_text_en: [
          {
            id: "yes",
            display_text: "Yes"
      ...
      },
      {
        ...
        'display_name_ar-LB': "Additional comments",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Date of Verification",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
...
FormSection.create_or_update!(
  {
    ...
    'name_ar-LB': "Verification",
    'description_ar-LB': "Verification",
    ...
    fields_attributes: [
      {
        ...
        'display_name_ar-LB': "Verification",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
