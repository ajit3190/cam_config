FormSection.create_or_update!(
  {
    name_en: "Screening Assessment",
    description_en: "Screening Assessment",
    name_so: "Qiimeyn baadhitaan",
    description_so: "Qiimeyn baadhitaan",
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        display_name_so: "Xayndaab ilaalin oo degdega",
        multi_select: false,
        hidden_text_field: false,
      ...
      {
        name: "displacement_status_if_other",
        visible: true,
        mobile_visible: true,
        hide_on_view_page: false,
        show_on_minify_form: false,
      ...
      },
      {
        ...
        display_name_so: "Xayndaabyada ilaalinta",
        multi_select: true,
        hidden_text_field: false,
      ...
      },
      {
        ...
        disabled: false,
        display_name_en: "If Other, please specify",
        display_name_so: "Haddii ay jiraan wax kale, fadlan faahfaahi",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      {
        name: "protection_concerns_notes",
        visible: true,
        mobile_visible: true,
        hide_on_view_page: false,
        show_on_minify_form: false,
        ...
        help_text_en: "Any other details about the child's protection concerns and the urgent concern to be addressed",
        display_name_so: "Qoraalo/Ogeysiisyo",
        help_text_so: "Faahfaahin kale oo la xidhiidha xayndaabka ilaalinta",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
