FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "يرجى ذكر اسماء الموظفين المسؤولين",
      ...
      },
      {
        ...
        help_text_i18n: {
          ar: "يرجى اختيار احدى انواع التدخل التي تبدأ بكلمة \"الخدمات\" فقط",
          en: "please choose the intervention that starts with \"Services\""
        },
        option_strings_source: "lookup lookup-service-type",
        order: 4,
        hidden_text_field: false,
        collapsed_field_for_subform_section_id: 638,
        autosum_total: false,
        autosum_group: "",
        link_to_path_external: true,
        field_tags: [],
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "التدخل مرتبط بأي هدف من اهداف خطة التدخل",
          en: "Intervention related to which objective/s in intervention plan"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "أفراد الاسرة الذين تم تقديم الخدمه لهم",
          en: "Family members involved in the service"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "يرجى ذكر اسماء افراد العائلة المشاركين",
          en: "Please provide the names of family members involved"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "للجلسات (جلسة تدخل عمل اجتماعي/ جلسة استشارية/ اسعاف نفسي اولي)",
          en: "For PSS Session/Consultation Session/Psychological first aid"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        help_text_i18n: {
          ar: "يرجى التعبئة فقط في حال جلسة تدخل عمل اجتماعي/ جلسة استشارية/ اسعاف نفسي اولي",
          en: "Please fill this only for PSS session/ consultation sessions/ psychological first aid\r\n"
        },
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "في حال غير ذلك ، يرجى التحديد",
      ...
      },
      {
        ...
        help_text_i18n: {
          ar: "يرجى ذكر وصف و ملخص لجلسة الدعم النفسي والاجتماعي/ الجلسة الاستشارية/ الاسعاف النفسي الاولي",
          en: "Please include PSS session/ consultation session/ psychological first aid content description, and summary"
        },
        order: 29,
        hidden_text_field: false,
        autosum_total: false,
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "المتابعة و نقاط العمل",
          en: "Follow up and action points"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "تم الحصول على الموافقة من قبل المستفيد",
          en: "Consent obtained from Client"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "تاريخ الحصول على الموافقة",
          en: "Date consent obtained"
        },
        help_text_i18n: {
          ar: "",
          en: "dd/mm/yy"
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "افراد العائلة الذين قاموا بالموافقة",
          en: "Consent obtained from whom in the family?"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: " اذا كان التحويل خارجي يرجى ذكر اسم الجهة المحول اليها",
          en: " If external (specify referral party)  "
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "اذا كان التحويل داخلي يرجى ذكر البرنامج",
          en: "If internal specify program"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "رد الجهة المحول اليها و وضع تقديم الخدمات",
          en: "Referral party feedback and Service provision status"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "رد المستفيد على التحويل",
          en: "Client feedback on referral status"
        },
        help_text_i18n: {
          ar: "",
          en: ""
        ...
        option_strings_text_i18n: [
          ...
          },
          {
            ...
            display_text: {
              ar: "لم يتم تلقي الخدمة بعد",
              en: "Service not received yet"
            }
          },
          {
            id: "no_contact_with_referral_party_happened_99772",
            display_text: {
              ar: "لم يتم التواصل مع الجهة المحولة",
              en: "No contact with referral party happened"
            }
          }
        ],
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "تفاصيل اكتمال الخدمة بشكل عام",
          en: "General date details"
        },
        help_text_i18n: {
          ar: "",
          en: ""
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "تاريخ اكتمال الخدمة",
          en: "Service Completed On"
        },
        help_text_i18n: {
          ar: "",
          en: ""
