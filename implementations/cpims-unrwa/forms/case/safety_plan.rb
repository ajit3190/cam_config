FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        help_text_i18n: {
          ar: "ما هي الموارد التي أستخدمها حالياً والتي أملكها والتي يمكن أن تساعدني للبقاء بأمان في المجالات التالية",
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "ما هي الخطوات التي اتخذتها الناجية كخيارات لتقليل المخاطر عند وقوع حادثة العنف (استراتيجيات السلامة)؟",
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          ar: "ما هي الخطوات التي حددتها الناجية كخيارات لتقليل المخاطر بعد مغادرتها المنزل / المجتمع إذا اختارت القيام بذلك؟",
        ...
        guiding_questions_i18n: {
          ar: "ومن الأمثلة على ذلك أن تعرف الناجية كيفية التعامل عاطفياً إذا ألقى الناس اللوم عليها بسبب مغادرتها؛ أن تعرف الناجية مع من تتحدث للحصول على الدعم؛ أن تكون الناجية على دراية بالصدمة والشدة التي تواجهها جراء حادثة العنف؛ أن تعرف الناجية ما يجب فعله حتى تشعر بالقوة.",
