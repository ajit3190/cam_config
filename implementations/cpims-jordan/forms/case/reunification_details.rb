FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Location where the reunification is taking place",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "Location",
        autosum_total: false,
      ...
      },
      {
        ...
        option_strings_text_en: [
          {
            id: "spontaneous",
            display_text: "Spontaneous / لم شمل بشكل تلقائي"
          },
          {
            id: "facilitated_by_agency",
            display_text: "Facilitated by agency / لم شمل عن طريق منظمة"
          }
        ],
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Was the child reunified with the verified adult?",
        multi_select: false,
        hidden_text_field: false,
