FormSection.create_or_update!(
  {
    name_en: "Best Interest Determination",
    description_en: "Best Interest Determination",
    ...
    fields_attributes: [
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Date of BID submission by caseworker",
        help_text_en: "",
        multi_select: false,
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Recommendation by caseworker",
        help_text_en: "",
        option_strings_text_en: [
          {
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Date of Recommendation  by caseworker",
        help_text_en: "",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Date of Recomendation by BID panel",
        help_text_en: "",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Recommendation by BID panel",
        help_text_en: "",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
