...
PrimeroModule.create_or_update!(
  {
    name: "FSS",
    description: "Family Support Service",
    associated_record_types: [
      "case",
      "tracing_request",
      "",
    ...
    form_sections: FormSection.where(unique_id: %w[basic_identity care_arrangements care_assessment gbv_case_closure_form cp_case_plan closure_form tracing_request_inquirer other_reportable_fields_tracing_request tracing_request_photos_and_audio tracing_request_record_owner tracing_request_tracing_request cp_case_plan_subform_case_plan_interventions tracing_request_subform_section care_arrangements_subform_other_persons_living_in_the_household cp_case_plan_subform_case_plan closure_form_subform_approvals_and_agreements tracing_request_inquirer_subform_other_family_members]),
    primero_program: PrimeroProgram.find_by(unique_id: 'primeroprogram-primero')
  }
)
