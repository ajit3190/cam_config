FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        'guiding_questions_ar-IQ': "Examples could include: The survivor knows how to deal emotionally if people blame her for leaving; The survivors knows who talk to for support; The survivor recognizes the trauma and stress that the situation has caused her; The survivor knows what to do to make her feel stronger.",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
