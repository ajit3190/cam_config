FormSection.create_or_update!(
  {
    ...
    'name_ar-IQ': "وثائق اخرى",
    'description_ar-IQ': "وثائق اخرى",
    name_ku: "بەلگەکانى تر",
    description_ku: "بەلگەکانى تر",
    ...
    fields_attributes: [
      {
        ...
        'display_name_ar-IQ': "وثائق اخرى",
        display_name_ku: "بەلگەکانى تر",
        multi_select: false,
