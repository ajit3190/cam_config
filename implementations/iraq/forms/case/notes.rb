FormSection.create_or_update!(
  {
    ...
    'name_ar-IQ': "نموذج ملاحظات فرعية متداخلة",
    'description_ar-IQ': "نموذج ملاحظات فرعية متداخلة",
    name_ku: "سەبفۆرمى تێبینیە رێکخراوەکان",
    description_ku: "سەبفۆرمى تێبینیە رێکخراوەکان",
...
FormSection.create_or_update!(
  {
    ...
    'name_ar-IQ': "الملاحظات",
    'description_ar-IQ': "الملاحظات",
    name_ku: "تێبینیەکان",
    description_ku: "تێبینیەکان",
    unique_id: "notes",
    parent_form: "case",
    visible: true,
    order: 20,
