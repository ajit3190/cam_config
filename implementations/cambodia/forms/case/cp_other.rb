    ...
    fields_attributes: [
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Other: Assess the child's status in another category if needed.",
          km: "ផ្សេងៗ៖ បា៉ន់ប្រមាណស្ថានភាពកុមារលើផ្នែកផ្សេងទៀតតាមការចាំបាច់"
        },
        help_text_i18n: {
          en: ""
        },
        ...
        collapsed_field_for_subform_section_id: 1672,
        autosum_total: false,
        autosum_group: "",
        ...
        collapsed_field_for_subform_unique_id: "cp_other_subform_other_section"
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Date of the Other Assessment",
          km: "កាលបរិច្ឆេទនៃការបា៉ន់ប្រមាណលើផ្នែកផ្សេងទៀត"
        },
        help_text_i18n: {
          en: ""
        },
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "What is this Other Assessment for?",
          km: "គោលបំណង"
        },
        help_text_i18n: {
          en: ""
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Provide details about this Other Assessment.",
          km: "ព័ត៌មានលម្អិត"
        },
        help_text_i18n: {
          en: ""
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Is the child's wellbeing seriously affected by the situation this assessment covers?",
          km: "តើបញ្ហានេះប៉ះពាល់ធ្ងន់ធ្ងរដល់សុខុមាលភាពរបស់កុមារដែរទេ?"
        },
        help_text_i18n: {
          en: ""
        },
    ...
    fields_attributes: [
      {
        ...
        display_name_i18n: {
          ...
          km: "បញ្ហានានាដែលត្រូវដោះស្រាយនៅក្នុងផែនការសេវាសម្រាប់ករណី - ផ្សេងៗ (កុមារ)"
        },
        help_text_i18n: {
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Most recent Other assessment scoring",
          km: "ពិន្ទុផ្នែកផ្សេងៗ (ចុងក្រោយ)"
        },
        help_text_i18n: {
