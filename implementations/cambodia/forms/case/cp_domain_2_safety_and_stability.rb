FormSection.create_or_update!(
  {
    ...
    name_i18n: {
      en: "Domain 2 - Safety and Stability",
      km: "ផ្នែកទី ២ - សុវត្ថិភាព និងស្ថិរភាព"
    },
    description_i18n: {
      en: "Domain 2 - Safety and Stability",
      km: "ផ្នែកទី ២ - សុវត្ថិភាព និងស្ថិរភាព"
    ...
    fields_attributes: [
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Domain 2 - Safety and Stability:  Assess the situation in terms of safety and stability.",
          km: "ផ្នែកទី ២ - សុវត្ថិភាព និងស្ថិរភាព៖ បា៉ន់ប្រមាណស្ថានភាព​ទាក់ទងនឹងសុវត្ថិភាព និងស្ថិរភាព។"
        },
        help_text_i18n: {
          en: ""
        },
        ...
        collapsed_field_for_subform_section_id: 1651,
        autosum_total: false,
        autosum_group: "",
        ...
        collapsed_field_for_subform_unique_id: "cp_domain_2_safety_and_stability_subform_family_needs_safety_section"
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Date of the Safety and Stability Assessment",
          km: "កាលបរិច្ឆេទនៃការបា៉ន់ប្រមាណសុវត្ថិភាព និងស្ថិរភាព។"
        },
        help_text_i18n: {
          en: ""
        },
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Is the family safe?",
          km: "តើគ្រួសារនេះមានសុវត្ថិភាពឬទេ?"
        },
        help_text_i18n: {
          en: "",
          km: ""
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "If no, is there any evidence of child protection issues?",
          km: "ប្រសិនបើទេ តើមានបញ្ហាដែលជាកង្វល់ដែរឬទេ?"
        },
        help_text_i18n: {
          en: ""
        },
        option_strings_text_i18n: [
          ...
          },
          {
            ...
            display_text: {
              ...
              km: "អំពើហិង្សាលើរាងកាយ"
            }
          },
          {
            id: "emotional_violence_42434",
            display_text: {
              en: "Emotional violence",
              km: "អំពើហិង្សាផ្លូវចិត្ត"
            }
          },
          {
            id: "neglect_95822",
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Is the family able to have a safe home?"
        },
        help_text_i18n: {
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Is there evidence of violence in the home?"
        },
        help_text_i18n: {
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Safety and Stability Scoring",
          km: "ពិន្ទុសុវត្ថិភាព និងស្ថិរភាព"
        },
        help_text_i18n: {
          en: "Average of Safety and Stability questions. To calculate sum all the questions' scores and divide by the number of scored questions. Decimal numbers must be rounded, if the decimals are less than 0.5 then round it down, if the decimals are 0.5 or more then round it up (for example, 2.4 should be 2 and 2.7 should be 3).",
          km: "ដើម្បីគណនាពិន្ទុមធ្យមផ្នែកសុវត្ថិភាព និងស្ថិរភាព សូមបូកសរុបពិន្ទុទាំងអស់ ហើយចែកនឹងចំនួនសំនួរដែលមានពិន្ទុ។ ក្នុងករណីពិន្ទុមានទសភាគ ត្រូវបង្គត់។"
        },
    ...
    fields_attributes: [
      {
        ...
        display_name_i18n: {
          ...
          km: "បញ្ហានានាដែលត្រូវដោះស្រាយនៅក្នុងផែនការសេវាសម្រាប់ករណី - សុវត្ថិភាព និងស្ថិរភាព (គ្រួសារ)"
        },
        help_text_i18n: {
      ...
      },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Most recent Safety and Stability scoring",
          km: "ពិន្ទុសុវត្ថិភាព និងស្ថិរភាព (ចុងក្រោយ)"
        },
        help_text_i18n: {
