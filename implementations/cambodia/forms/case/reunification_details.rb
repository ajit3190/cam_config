FormSection.create_or_update!(
  {
    ...
    name_i18n: {
      ...
      km: "ការ​បង្រួបបង្រួម Nested"
    },
    description_i18n: {
      en: "Reunification Subform",
      km: "ទម្រង់រង​ការ​បង្រួបបង្រួម"
    },
    parent_form: "case",
    visible: false,
    order: 20,
    ...
    fields_attributes: [
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Name of adult, foster carer, kinship carer or facility"
        },
        help_text_i18n: {
          en: ""
        },
        order: 1,
        hidden_text_field: false,
        collapsed_field_for_subform_section_id: 1703,
        autosum_total: false,
        autosum_group: "",
        link_to_path_external: true,
        field_tags: [],
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Location where the reunifcation or placement is taking place"
        },
        help_text_i18n: {
          en: "Enter country, province, district, commune, village when searching for a location"
        },
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Date of reunification or placement"
        },
        help_text_i18n: {
          en: ""
        },
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Was the carer formally approved by the competent authority?"
        },
        help_text_i18n: {
          en: ""
        },
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Was the placement approved by a competent authority?"
        },
        help_text_i18n: {
          en: ""
        },
        ...
        },
      {
        ...
        disabled: false,
        display_name_i18n: {
          en: "Name of government official witnessing the reunification or placement"
        },
        help_text_i18n: {
          en: ""
        },
...
FormSection.create_or_update!(
  {
    ...
    name_i18n: {
      en: "Child Placement and Reunification",
      km: "ព័ត៌មាន​លម្អិត​អំពី​ការ​បង្រួបបង្រួម"
    },
    description_i18n: {
