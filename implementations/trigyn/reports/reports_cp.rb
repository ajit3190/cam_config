...
default_filters_with_consent_reporting = default_case_filters + [{ 'attribute' => 'consent_reporting', 'value' => ['true'] }]
consent_reporting_note = 'Note: This report only includes data where the individual has provided consent to share non-identifying information for reporting.'
...
Report.create_or_update!(
  ...
  description_all: "Number of cases broken down by nationality. #{consent_reporting_note}",
  module_id: PrimeroModule::CP,
  record_type: 'case',
  aggregate_by: ['nationality'],
  filters: default_filters_with_consent_reporting,
  is_graph: true,
  editable: false
)
...
Report.create_or_update!(
  ...
  description_all: "Number of cases broken down by age and sex. #{consent_reporting_note}",
  module_id: PrimeroModule::CP,
  record_type: 'case',
  aggregate_by: ['age'],
  disaggregate_by: ['sex'],
...
Report.create_or_update!(
  ...
  description_all: "Number of cases broken down by protection concern and sex. #{consent_reporting_note}",
  module_id: PrimeroModule::CP,
  record_type: 'case',
...
Report.create_or_update!(
  ...
  description_all: "The care arrangements broken down by age and sex. #{consent_reporting_note}",
  module_id: PrimeroModule::CP,
  record_type: 'case',
  aggregate_by: ['current_care_arrangements_type'],
...
Report.create(
  name_all: 'CP Cases with provided consent to share non-identifying information',
  description_all: 'How many cases have responded "Yes" or "No" to share non-identifying information for reporting',
  module_id: PrimeroModule::CP,
  record_type: 'case',
  aggregate_by: ['consent_reporting'],
  filters: default_case_filters,
  is_graph: true,
  editable: false
)
