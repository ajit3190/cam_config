FormSection.create_or_update!(
  {
    ...
    name_fr: "Consentement pour Services",
    description_fr: "Consentement pour Services",
    name_ar: "الموافقة على الخدمات",
    description_ar: "الموافقة على الخدمات",
    'name_ar-LB': "Consent for Services",
    'description_ar-LB': "Consent for Services",
    name_es: "Consent for Services",
    description_es: "Consent for Services",
    ...
    fields_attributes: [
      {
        ...
        display_name_fr: "Consentement pour Services",
        display_name_ar: "الموافقة على الخدمات",
        'display_name_ar-LB': "Consent for Services",
        display_name_es: "Consent for Services",
        multi_select: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "Did the survivor provide consent to engage in services offered by you?",
        'tick_box_label_ar-LB': "Yes",
        display_name_es: "Did the survivor provide consent to engage in services offered by you?",
