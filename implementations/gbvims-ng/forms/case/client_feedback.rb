FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Did you feel that you received all the information you needed about your options for services and referrals?",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no-not-applicable",
        autosum_total: false,
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Did you make decisions about what you wanted to happen with your case (in terms of next steps)?",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no-not-applicable",
        autosum_total: false,
