    ...
    fields_attributes: [
      {
        ...
        'display_name_ar-LB': "Is a safety plan needed for this case?",
        'help_text_ar-LB': "Safety planning enables the survivor to proceed with a pre-determined course of action when she is in a lifethreatening situation. Safety planning can help her minimize the harm done by the perpetrator by identifying resources and means to avoid harm and places she can go temporarily for safety. Developing a safety plan is a collaborative process undertaken by the casework and survivor together. The safety plan addresses the fundamental question: what needs to happen or  to be in place in order for the survivor to safe? It includes identifying: dangerous situations, risks and warning signs, activities survivor can undertake on her own, specific people to call on for help, supportive people that make sruvivor feel safe and  survivor's own stregngths that help her get by.",
        display_name_es: "Is a safety plan needed for this case?",
        help_text_es: "Safety planning enables the survivor to proceed with a pre-determined course of action when she is in a lifethreatening situation. Safety planning can help her minimize the harm done by the perpetrator by identifying resources and means to avoid harm and places she can go temporarily for safety. Developing a safety plan is a collaborative process undertaken by the casework and survivor together. The safety plan addresses the fundamental question: what needs to happen or  to be in place in order for the survivor to safe? It includes identifying: dangerous situations, risks and warning signs, activities survivor can undertake on her own, specific people to call on for help, supportive people that make sruvivor feel safe and  survivor's own stregngths that help her get by.",
        multi_select: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "Was a safety plan developed with the survivor (if applicable)?",
        display_name_es: "Was a safety plan developed with the survivor (if applicable)?",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        'display_name_ar-LB': "Safety Plan Completion Date",
        display_name_es: "Safety Plan Completion Date",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Identify safety concern (in survivor's words)",
        display_name_es: "Identify safety concern (in survivor's words)",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Resources",
        'help_text_ar-LB': "Name the resources I am using now that I have, that can help me stay safe in following categories",
        display_name_es: "Resources",
        help_text_es: "Name the resources I am using now that I have, that can help me stay safe in following categories",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Economic / material",
        display_name_es: "Economic / material",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Relationships",
        display_name_es: "Relationships",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Community help",
        display_name_es: "Community help",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Other",
        display_name_es: "Other",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Safety preparedness",
        display_name_es: "Safety preparedness",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "What steps did the survivor identify as options to minimize risk of further harm for herself (and her children) before violence occurs (safety preparedness)?",
        display_name_es: "What steps did the survivor identify as options to minimize risk of further harm for herself (and her children) before violence occurs (safety preparedness)?",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Safety strategies",
        display_name_es: "Safety strategies",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "What actions did the survivor identify as options to mitigate risks when violence happens (safety strategies)?",
        display_name_es: "What actions did the survivor identify as options to mitigate risks when violence happens (safety strategies)?",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "Steps after leaving",
        display_name_es: "Steps after leaving",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "What steps did the survivor identify as options to minimze risks after leaving her home/community if she chooses to do so?",
        display_name_es: "What steps did the survivor identify as options to minimze risks after leaving her home/community if she chooses to do so?",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        'display_name_ar-LB': "How long did it take you to develop the safety plan with the survivor for this case?",
        display_name_es: "How long did it take you to develop the safety plan with the survivor for this case?",
        multi_select: false,
        hidden_text_field: false,
