FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      {
        name: "relation_child_wants_reunion",
        visible: true,
        mobile_visible: true,
        hide_on_view_page: false,
        show_on_minify_form: false,
        ...
        editable: true,
        disabled: false,
        display_name_en: "Does the child want to be reunified with this person?",
        help_text_en: "",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Age Category",
        help_text_en: "",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-age-categories",
        autosum_total: false,
        autosum_group: "",
        required: false
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Current Address/Landmark",
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Current District/Chiefdom",
        help_text_en: "",
        multi_select: false,
        hidden_text_field: false,
