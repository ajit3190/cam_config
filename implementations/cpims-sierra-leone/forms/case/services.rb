FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        option_strings_text_en: [
          ...
          },
          {
            ...
            display_text: "Education Support "
          },
          {
            id: "interim_care",
          ...
          {
            id: "family_tracing_ftr",
            display_text: "Family Tracing (FTR)"
          },
          {
            id: "clothing_and_or_non_food_item",
            display_text: "Clothing and/or Non-Food Item "
          },
          {
            id: "food_and_or_nutritional_support",
            display_text: "Food and/or Nutritional Support "
          },
          {
            id: "case_management_on_going_monitoring",
            display_text: "Case Management / On-Going Monitoring"
          },
          {
            id: "legal_aid",
            display_text: "Legal Aid "
          },
          {
            id: "livelihood_support_skills_training",
            display_text: "Livelihood Support/Skills Training "
          },
          {
            id: "other",
            display_text: "Other"
      ...
      {
        name: "service_protection_concern_explanation",
        visible: true,
        mobile_visible: true,
        hide_on_view_page: false,
        show_on_minify_form: false,
        ...
        editable: true,
        disabled: false,
        display_name_en: "Brief explanation of Protection Concerns leading to referral. (Recommend narrative)",
        help_text_en: "",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Date Service Provided",
        help_text_en: "",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Service successfully provided?",
        help_text_en: "This field is used in a report",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
      ...
      },
      {
        ...
        editable: true,
        disabled: false,
        display_name_en: "Organization Providing Service",
        help_text_en: "The name of the organization providing the service",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
