FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: "پلانا کریارێ یا تێکەل",
    description_ku_IQ: "فورما نەسەرەکیا پلانا کریارێ",
    ...
    fields_attributes: [
      {
        ...
        display_name_ku_IQ: "پلانا کریارێ وەسف بکە بۆ چارەسەرکرنا پێدڤیا",
        multi_select: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "جورێ پێدڤیێ",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ل دەمێ گونجایی، تە رزگاربووی رەوانەکریە ڤێ خزمەتگوزاریێ",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەرێ تە رازەمەندی ل سەر وەرەقێ ژ رزگاربووی وەرگرت بۆ بەلاڤکرنا پێزانینا ژبۆ مەرەما رەوانەکرنێ؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "مێژوویا ژڤانی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "دابینکەرێ خزمەتگوزاریێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "جهێ خزمەتگوزاریێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەگەر جێبەجێکرنا قانونێن راپورتکرنێ نەچاری بیت، تە ریدان بو پولیس یان دەسەلاتا گشتی راپورتکریە؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەگەر بەلێ، تە رزگاربووی و یان چاڤدێرێن وێ ژ قانونا نەچاریا راپورتکرنێ ژ بەری دروستکرنا راپورتێ ئاگەهدارکریە؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "تە چەند دەم بو دانانا پلانا کریارێن کەیسی دگەل رزگاربووی بۆ ڤی کەیسی دەربازکری؟",
        multi_select: false,
        hidden_text_field: false,
...
FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: "یا تێکەل GBV فورما نەسەرەکیا دیفچوونا",
    description_ku_IQ: "یا تێکەل GBV فورما نەسەرەکیا دیفچوونا",
    ...
    fields_attributes: [
      {
        ...
        display_name_ku_IQ: "جورێن خزمەتگوزاریێن ژ لایێ من یان رێکخراوا من ڤە هاتینە دابینکرن",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-service-type",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "مێژوویا دیفچوونێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "جورێ خزمەتگوزاریا رەوانەکرنێ",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-service-type",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "کریار هاتیە ئەنجامدان؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "وردەکاری لسەر کریارا هاتیە کرن",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەگەر بەلێ، کەنگی خزمەتگوزاری هاتیە دابینکرن؟",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەرێ پێدڤی ب سەرەدانێن زێدەتر یێن دیفچوونێ هەیە؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەگەر بەلێ، بۆ سەرەدانا بهێت تو چ دەم پێشنیار دکەی؟",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ل دەما ژڤانێ دیفچوونێ، ئەرێ رزگاربووی بەحسا چ پێدڤیێن نی یان ژی نیگەرانیا کر؟",
        help_text_ku_IQ: "ئەگەر بەلێ، هیڤیدارین وان پێدڤیا وەسف بکە و لدیف هندێ پێداچوونێ د بەشێ پلانا کریارا کەیسی دا بکە",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەو کریارێن هاتینە کرن لدیف پێدڤیێن رزگاربووی بوو؟",
        help_text_ku_IQ: "ئەگەر نە، هیڤیدارین لدیف هندێ بەشێ پلانا کریارا کەیسی ئاپدەیت بکە بۆ چارەسەرکرنا وان پێدڤیا",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەگەر نە، تە رزگاربوو رەوانەکریە ژبۆ چاڤپێکەفتنەکا دی؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەگەر هەمی پێدڤی هاتبنە جێبەجێکرن، تو پێشنیار دکەی کەیس بهێتە گرتن؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "بۆ جێبەجێکرنا پلانا کریارا کەیسی بۆ ڤێ ریدانێ چەند وەختێ تە پێڤە چوو؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-duration",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤەچوون بەرەف گەهشتن ب ئارمانجا ڤە هاتە کرن",
        help_text_ku_IQ: "پێشڤەچوونا بەرەف گەهشتن ب ئارمانجا ڤە هاتە دیتن هەلسەنگینە، ل گوری رێکەفتنا ل سەر هاتیە کرن بۆ هەلسەنگاندنا رزگاربووی و پلانا کارێ کەیسی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤەچوون بەرەف ئارمانجێن ئێمناهیێ",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤچوونا بەرەف ئارمانجێن ئێمناهێ شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤەچوون بەرەف ئارمانجێن ساخلەمیێ",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-progress",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤچوونا بەرەف ئارمانجێن ساخلەمیێ شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤەچوون بەرەف ئارمانجێن پشتەڤانیا دەروونی",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-progress",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤچوونا بەرەف ئارمانجێن پشتەڤانیا دەروونی شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤەچوون بەرەف ئارمانجێن دادوەریێ یان یاسایی",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-progress",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤچوونا بەرەف گەهشتن ب ئارمانجێن دادوەریێ یان یاسایی شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئارمانجێن دی (ل ڤێرە بکە لیست",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤەچوون بەرەف ئارمانجێن دی",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-progress",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "پێشڤچوونا بەرەف ئارمانجێن دی شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
...
FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: "پلانا کریارێ",
    description_ku_IQ: "پلانا کریارێ",
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        display_name_ku_IQ: "هاتية ثةسةند كرن ذلايى ريظةبةرى ظة",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "تيَبينييَت ريَظةبةرى ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "لینکێن ریدانێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "پلانا کریارێ",
        help_text_ku_IQ: "هیڤیدارین هەمی پێدڤیێن تە د هەلسەنگاندنێ دا دەستنیشانکرین زێدە بکە. دوکما زێدەکرنێ بکاربینە بۆ زێدەکرنا پێدڤیێن دی کو پێدڤیە پشکەک بن ژ پلانا کریارێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
