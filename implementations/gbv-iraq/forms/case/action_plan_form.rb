    ...
    fields_attributes: [
      {
        ...
        display_'name_ku-IQ': "پلانا کریارێ وەسف بکە بۆ چارەسەرکرنا پێدڤیا",
        multi_select: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "جورێ پێدڤیێ",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ل دەمێ گونجایی، تە رزگاربووی رەوانەکریە ڤێ خزمەتگوزاریێ",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەرێ تە رازەمەندی ل سەر وەرەقێ ژ رزگاربووی وەرگرت بۆ بەلاڤکرنا پێزانینا ژبۆ مەرەما رەوانەکرنێ؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "مێژوویا ژڤانی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "دەمێ ژڤانی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "دابینکەرێ خزمەتگوزاریێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "جهێ خزمەتگوزاریێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەگەر جێبەجێکرنا قانونێن راپورتکرنێ نەچاری بیت، تە ریدان بو پولیس یان دەسەلاتا گشتی راپورتکریە؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەگەر بەلێ، تە رزگاربووی و یان چاڤدێرێن وێ ژ قانونا نەچاریا راپورتکرنێ ژ بەری دروستکرنا راپورتێ ئاگەهدارکریە؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "تە چەند دەم بو دانانا پلانا کریارێن کەیسی دگەل رزگاربووی بۆ ڤی کەیسی دەربازکری؟",
        multi_select: false,
        hidden_text_field: false,
    ...
    fields_attributes: [
      {
        ...
        display_'name_ku-IQ': "جورێن خزمەتگوزاریێن ژ لایێ من یان رێکخراوا من ڤە هاتینە دابینکرن",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-service-type",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "مێژوویا دیفچوونێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "جورێ خزمەتگوزاریا رەوانەکرنێ",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-service-type",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "کریار هاتیە ئەنجامدان؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "وردەکاری لسەر کریارا هاتیە کرن",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەگەر بەلێ، کەنگی خزمەتگوزاری هاتیە دابینکرن؟",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەرێ پێدڤی ب سەرەدانێن زێدەتر یێن دیفچوونێ هەیە؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەگەر بەلێ، بۆ سەرەدانا بهێت تو چ دەم پێشنیار دکەی؟",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ل دەما ژڤانێ دیفچوونێ، ئەرێ رزگاربووی بەحسا چ پێدڤیێن نی یان ژی نیگەرانیا کر؟",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەو کریارێن هاتینە کرن لدیف پێدڤیێن رزگاربووی بوو؟",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەگەر نە، تە رزگاربوو رەوانەکریە ژبۆ چاڤپێکەفتنەکا دی؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەگەر هەمی پێدڤی هاتبنە جێبەجێکرن، تو پێشنیار دکەی کەیس بهێتە گرتن؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "بۆ جێبەجێکرنا پلانا کریارا کەیسی بۆ ڤێ ریدانێ چەند وەختێ تە پێڤە چوو؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-duration",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤەچوون بەرەف گەهشتن ب ئارمانجا ڤە هاتە کرن",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤەچوون بەرەف ئارمانجێن ئێمناهیێ",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤچوونا بەرەف ئارمانجێن ئێمناهێ شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤەچوون بەرەف ئارمانجێن ساخلەمیێ",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-progress",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤچوونا بەرەف ئارمانجێن ساخلەمیێ شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤەچوون بەرەف ئارمانجێن پشتەڤانیا دەروونی",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-progress",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤچوونا بەرەف ئارمانجێن پشتەڤانیا دەروونی شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤەچوون بەرەف ئارمانجێن دادوەریێ یان یاسایی",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-progress",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤچوونا بەرەف گەهشتن ب ئارمانجێن دادوەریێ یان یاسایی شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئارمانجێن دی (ل ڤێرە بکە لیست",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤەچوون بەرەف ئارمانجێن دی",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-assessment-progress",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێشڤچوونا بەرەف ئارمانجێن دی شروڤە بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
...
FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        display_'name_ku-IQ': "هاتية ثةسةند كرن ذلايى ريظةبةرى ظة",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "تيَبينييَت ريَظةبةرى ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "لینکێن ریدانێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پلانا کریارێ",
