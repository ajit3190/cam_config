FormSection.create_or_update!(
  {
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ناسناما کەیسی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "روژا ژدایکبوونێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "هوز یان نەژاد",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "نەتەوە، (ئەگەر وەك وەلاتێ رەسەن نەبیت)",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ژمارە و تەمەنێ زاروکا",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەرێ رزگاربوو کەسەکێ خودان پێدڤیێن تایبەتە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەرێ رزگاربوو سنێلەکێ بتنێ یە، زاروکەکێ جودابوویی ژ خێزانا خویە یان ژ زاروکێن دی یێن لاوازە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "رزگاربوویێن زاروك (ل ژێر تەمەنێ ١٨ سالیێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەرێ رزگاربوو زاروکە، ئەرێ ئەو بتنێ دژیت؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەرێ رزگاربوو دگەل کەسەکی دژیت، پەیوەندی دناڤبەرا وان چیە؟",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەگەر پەیوەندیێن دی دناڤبەرا وی و چاڤدێری بن، هیڤیدارین دیار بکەی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "بارودوخێ هەڤژینیێ چاڤدێری چییە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "کارێ سەرەکی یێ چاڤدێری چییە؟",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
