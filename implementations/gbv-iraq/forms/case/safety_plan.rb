FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: "پلانا ئێمناهیێ",
    description_ku_IQ: "پلانا ئێمناهیێ",
    ...
    fields_attributes: [
      {
        ...
        display_name_ku_IQ: "ئەرێ پلانەکا ئێمناهیێ بۆ ڤی کەیسی یا پێدڤیە؟",
        help_text_ku_IQ: "پلانا سەلامەتیێ هاریکاریا کەسا رزگاربوى دکەت ژبو زانینا هندێ کا ژ پێنگاڤ بگریتە بەر لدەمێ مەترسى لسەر ژیانا وێ هەبیت. پلانا سەلامەتیێ هاریکاریا رزگاربویێ دکەت ژبو کێم کرنا وێ توند و تیژیا دهێته ئەنجام دان ژلایێ تاوانبارى ڤە. هەروەسا داکوبشێت بجیتە جهەکى ئارام بو ماوەکى دیار کرى تاکو ژ وێ توند و تیژیێ یا پاراستى بیت. بو دانا ڤێ پلانێ دڤێت هەردوو ئالی پێکڤە بدانن ( کارمەندێ رێکخراوێ و کەسا رزگاربوى). هندەک پرسیارێن سەرەکى بو دانانا پلانێ : چ کار دڤێت بهێتە ئەنجام دان ژبو سەلامەتیا کەسا رزگاربوى ؟ هەروەسا فان خالاژى بەرجاڤ وەربگرە: ",
        multi_select: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەرێ پلانا ئێمناهیێ ژلایێ رزگاربوویێ بخوڤە هاتیە دانان (ئەگەر یا پەیوەندیدار بیت) ؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "مێژوویا تمامبوونا پلانا ئێمناهیێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "دەستنیشانکرنا نیگەرانیێن ئێمناهیێ \n(ب پەیڤێن رزگاربوویی بخو)",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ژێدەر",
        help_text_ku_IQ: "ئاماژە ب وان ژێدەرا بکە یێن من هەین کو ئەز نوکە بکاردئینم، کو هاریکارن ئەز ل ڤان کاتێگوریا (چینا) پاراستی بم.",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئابوری\\ مادی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        help_text_ku: "",
        display_name_ku_IQ: "جورێ پەیوەندیێ",
        help_text_ku_IQ: "",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "هاریکاریا جڤاکی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "بەرهەڤیێن ئێمناهیێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ستراتیژیێن ئێمناهیێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "هەکه کەسا رزگاربوى بریار دابیت رابيت بجهـ  هێلانا مالا خو و کومەلگەها خو, چ هەلبژارتن گرتینە بەر ژبو کێم کرنا مەترسیێ ؟ ",
        help_text_ku_IQ: "",
        guiding_questions_ku_IQ: "هندەک ژنمونا: کەسارزگاربوى بزانیت کا چاوا دێ سەرەدەریێ دگەل هەستێت خو کەت ئەگەر هات و چڤاکى کره خەلەتیا وێ یان ب تاوان قەلەم دا, بزانیت لوى دەمى دێ داخازا هاریکاریێ ژکى کەتن, بزانیت ژ ئەگەری وان کاودانا بیت تروما و ستریس لدوف پەیدا بیتن. هەروەسا ژ بکەتن دا بهێز بکەڤیت و خو لبەر ڤان کاودانا بگریت. ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "تە چەند دەم بۆ دانانا پلانا ئێمناهیێ بۆ ڤی کەیسی دگەل رزگاربووی دەربازکر؟",
        multi_select: false,
        hidden_text_field: false,
