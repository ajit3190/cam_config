    ...
    fields_attributes: [
      {
        ...
        display_'name_ku-IQ': "ئەرێ پلانەکا ئێمناهیێ بۆ ڤی کەیسی یا پێدڤیە؟",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەرێ پلانا ئێمناهیێ ژلایێ رزگاربوویێ بخوڤە هاتیە دانان (ئەگەر یا پەیوەندیدار بیت) ؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "مێژوویا تمامبوونا پلانا ئێمناهیێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "دەستنیشانکرنا نیگەرانیێن ئێمناهیێ \n(ب پەیڤێن رزگاربوویی بخو)",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئابوری\\ مادی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        help_text_ku: "",
        display_'name_ku-IQ': "جورێ پەیوەندیێ",
        help_text_ku-IQ: "",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "هاریکاریا جڤاکی",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "بەرهەڤیێن ئێمناهیێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "کەسا رزگاربوى چ پێنگاڤ هاڤێتینە ژبو کێم کرنا مەترسیێ لسەر خو و زاروکێن خو بەرى توند و تیژى بهێته ئەنجام دان (ئامادەکاریێن سەلامەتیێ)؟ ",
        help_text_ku-IQ: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ستراتیژیێن ئێمناهیێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "پێنگاڤێن پشتی بجههێلانێ",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "هەکه کەسا رزگاربوى بریار دابیت رابيت بجهـ  هێلانا مالا خو و کومەلگەها خو, چ هەلبژارتن گرتینە بەر ژبو کێم کرنا مەترسیێ ؟ ",
        help_text_ku-IQ: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "تە چەند دەم بۆ دانانا پلانا ئێمناهیێ بۆ ڤی کەیسی دگەل رزگاربووی دەربازکر؟",
        multi_select: false,
        hidden_text_field: false,
