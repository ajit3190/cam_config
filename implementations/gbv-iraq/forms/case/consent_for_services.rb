FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: "رازەمەندی بۆ خزمەتگوزاریا",
    description_ku_IQ: "رازەمەندی بۆ خزمەتگوزاریا",
    ...
    fields_attributes: [
      {
        ...
        display_name_ku_IQ: "رازەمەندی بۆ خزمەتگوزاریا",
        multi_select: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەرێ رزگاربوویێ رازەمەندی دا بۆ پشکداریکرن د خزمەتگوزاریێن ژ لایێ تە ڤە هاتینە پێشکێشکرن؟",
