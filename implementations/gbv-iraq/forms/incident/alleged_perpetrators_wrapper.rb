FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: "فورما نەسەرەکیا تاوانبارێ گومانلێکری یا تێکەل",
    description_ku_IQ: "فورما نەسەرەکیا تاوانبارێ گومانلێکری یا تێکەل",
    ...
    fields_attributes: [
      {
        ...
        display_name_ku_IQ: "ئەرێ ئەڤە تاوانبارێ سەرەکییە؟",
      ...
      },
      {
        ...
        display_name_ku_IQ: "رەگەزێ تاوانبارێ گومانلێکری",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        help_text_ku: "",
        display_name_ku_IQ: "توندو تیژی لسەر بنیاتێ رەگەزی یابەرێ ژ لایێ تاوانبارێ گومانلێکری",
        help_text_ku_IQ: "",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "نەتەوەیێ تاوانبارێ گومانلێکری",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "هوز یان نەژادێ تاوانبارێ گومانلێکری",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "گروپێ تەمەنێ تاوانێ پێشبینیکری",
        option_strings_text_en: [
          {
            id: "0_11",
            display_text: "0-11"
      ...
      },
      {
        ...
        display_name_ku_IQ: "جورێ تەمەنێ تاوانبارێ گومانلێکری",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "پەیوەندیا تاوانبارێ گومانلێکری دگەل رزگاربووی",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        help_text_ku: "",
        display_name_ku_IQ: "كارێ تاوانبارى",
        help_text_ku_IQ: "",
        option_strings_text_en: [
          {
            id: "other",
...
FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: "تاوانبارێ گومانلێکری",
    description_ku_IQ: "تاوانبارێ گومانلێکری",
    ...
    fields_attributes: [
      {
        ...
        display_name_ku_IQ: "تاوانبارێ گومانلێکری",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
