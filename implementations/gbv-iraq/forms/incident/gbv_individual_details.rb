FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: "وردەکاریێن کەسی یێن توندو تیژی لسەر بنیاتێ رەگەزی",
    description_ku_IQ: "وردەکاریێن کەسی یێن توندو تیژی لسەر بنیاتێ رەگەزی",
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        display_name_ku_IQ: "رەگەزێ رزگاربووی چییە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "روژا ژدایکبوونا رزگاربووی چییە؟",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        help_text_ku: "",
        display_name_ku_IQ: "تەمەنێ رزگاربووی چەندە؟",
        help_text_ku_IQ: "ذمارة دظيَت بزمانىَ ئينطليزى بهيَنة نظيَسان",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەرێ تەمەن تەخمینکریە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "نەژادێ رزگاربووی چيە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "رزگاربووی لایەنگرێ چ نەتەوەیە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "رزگاربوویی لایەنگرێ کیش ئاینی یە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        help_text_ku: "",
        display_name_ku_IQ: "جورێ پەککەفتن یا کێم ئەندامیێ",
        help_text_ku_IQ: "",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەرێ رزگاربوو کەسەکێ ل ژێر تەمەنێ قانونی یە و یێ بتنێ یە، زاروکەکێ جودابوویی یە ژ خێزانا خو یان ژ زاروکێن دی یێن لاوازە؟",
        multi_select: false,
        hidden_text_field: false,
