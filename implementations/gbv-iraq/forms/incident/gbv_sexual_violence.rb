FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: " فورما نەسەرەکیا توندو تیژی لسەر بنیاتێ رەگەزی ل جهەکێ دی هاتیە راپورتکرن",
    description_ku_IQ: "فورما نەسەرەکیا توندو تیژی لسەر بنیاتێ رەگەزی ل جهەکێ دی هاتیە راپورتکرن",
    ...
    fields_attributes: [
      {
        ...
        display_name_ku_IQ: "جورێ دابینکەرێ خزمەتگوزاریێ ل دەما کو رزگاربووی ریدان راپورتکری",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ناڤێ دابینکەرێ خزمەتگوزاریێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
...
FormSection.create_or_update!(
  {
    ...
    name_ku_IQ: "جورێ تۆندووتیژیێ",
    description_ku_IQ: "جورێ تۆندووتیژیێ",
    ...
    fields_attributes: [
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەگەر تۆندووتیژیا نە ل سەر بنەمایێ رەگەزی بیت، وەسف بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        help_text_ku: "",
        display_name_ku_IQ: "ئەرێ ئەڤ ریدانە کارەکێ نەریتیێ ب زیان بوو",
        help_text_ku_IQ: "",
        option_strings_text_en: [
          {
            id: "no",
      ...
      },
      {
        ...
        help_text_ku: "",
        display_name_ku_IQ: "ئەرێ ئالوگوریا پارە، کەل و پەل، مفا و یان ژی خزمەتگوزاریا هاتیە کرن گرێدای ڤێ ریدانێ بوو؟",
        help_text_ku_IQ: "",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "جورێ رەڤاندنێ ل دەمێ ریدانێ",
        option_strings_text_en: [
          {
            id: "none",
            display_text: "None"
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەرێ بریکاری ئەڤ رویدانە ل جهێن دی راپورتکریە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەگەر بەلێ، ل کیڤە؟",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_name_ku_IQ: "ئەرێ بەری نوکە چ ریدانێن تاوانا  ل سەر بنەمایێ رەگەزی ل دژی بریکاری هاتینە ئەنجام دان؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
