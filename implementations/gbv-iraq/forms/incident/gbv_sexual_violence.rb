    ...
    fields_attributes: [
      {
        ...
        display_'name_ku-IQ': "جورێ دابینکەرێ خزمەتگوزاریێ ل دەما کو رزگاربووی ریدان راپورتکری",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ناڤێ دابینکەرێ خزمەتگوزاریێ",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
    ...
    fields_attributes: [
      {
        ...
        display_'name_ku-IQ': "جورێ ریدانا تۆندووتیژیێ",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەگەر تۆندووتیژیا نە ل سەر بنەمایێ رەگەزی بیت، وەسف بکە",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        help_text_ku: "",
        display_'name_ku-IQ': "ئەرێ ئەڤ ریدانە کارەکێ نەریتیێ ب زیان بوو",
        help_text_ku-IQ: "",
        option_strings_text_en: [
          {
            id: "no",
      ...
      },
      {
        ...
        help_text_ku: "",
        display_'name_ku-IQ': "ئەرێ ئالوگوریا پارە، کەل و پەل، مفا و یان ژی خزمەتگوزاریا هاتیە کرن گرێدای ڤێ ریدانێ بوو؟",
        help_text_ku-IQ: "",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "جورێ رەڤاندنێ ل دەمێ ریدانێ",
        option_strings_text_en: [
          {
            id: "none",
            display_text: "None"
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەرێ بریکاری ئەڤ رویدانە ل جهێن دی راپورتکریە؟",
        multi_select: false,
        hidden_text_field: false,
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەگەر بەلێ، ل کیڤە؟",
        multi_select: false,
        hidden_text_field: false,
        autosum_total: false,
        autosum_group: "",
      ...
      },
      {
        ...
        display_'name_ku-IQ': "ئەرێ بەری نوکە چ ریدانێن تاوانا  ل سەر بنەمایێ رەگەزی ل دژی بریکاری هاتینە ئەنجام دان؟",
        multi_select: false,
        hidden_text_field: false,
        option_strings_source: "lookup lookup-yes-no",
        autosum_total: false,
