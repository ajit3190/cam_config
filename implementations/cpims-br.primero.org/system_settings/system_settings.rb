...
create_or_update_system_setting(
  {
    ...
    'welcome_email_text_pt-BR': "Click link below to log into Primero.  Please see your system administrator if you have any issues.",
    ...
    'approvals_labels_pt-BR': {
      assessment: "BIA",
      case_plan: "Plano de caso",
