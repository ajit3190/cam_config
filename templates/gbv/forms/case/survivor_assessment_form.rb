...
survivor_assessment_fields = [
  Field.new('name' => 'assessment_emotional_state_header',
            ...
            'guiding_questions' => [
                  ...
                  '',
                  'Is she a resident, a refugee or internally displaced person?'].join("\n"),
  ...
  Field.new('name' => 'assessment_survivor_background',
            ...
            'guiding_questions' => [
              'Survivor Context (or Background Information)',
              '',
              'Provide basic contextual information on the survivor, including her family situation, current living situation, occupation or role, and any other relevant information.'
            ].join("\n")),
  Field.new('name' => 'assessment_family_situation',
            ...
            'guiding_questions' => [
                  "Survivor's family situation (for adults)",
                  '',
                  ...
                  '',
                  'Who are the other family members present in the client’s life on a daily basis?  Does the survivor have other relatives that are present in her life?'].join("\n")),
  Field.new('name' => 'assessment_current_living_situation',
            ...
            'guiding_questions' => [
              ...
              '',
              'Does the survivor have a place to live? Where? Who lives in the house with her? Does she live with her husband/intimate partner? Are there relatives living nearby?'
            ].join("\n")),
  Field.new('name' => 'assssment_survivor_occupation',
            ...
            'guiding_questions' => [
              ...
              '',
              'Does the survivor work? Is her work at home? Does s/he have paid employment? Part-time or full-time? Does the survivor have a special role in the community where s/he lives?'
            ].join("\n")),
  Field.new('name' => 'assessment_child_considerations',
            ...
            'guiding_questions' => [
              ...
              '',
              'Does she live with her parents? (If her parents or guardians are not the perpetrators, do they know about what happened to her)?',
              '',
              "Who are the other family members present in the client's life on a daily basis?",
              '',
              ' Does the survivor have other relatives that are present in her life?'
            ].join("\n")),
  Field.new('name' => 'assessment_presenting_problem',
            ...
            'guiding_questions' => [
                  'Reasons for seeking case management services',
                  '',
                  "Identify what problem(s)/concern(s)/issue(s) the survivor is requesting assistance/support for.",
                  "These might include: immediate safety, children's safety, access to economic resources, medical assistance, perception of others, etc."].join("\n")),
  Field.new('name' => 'assessment_emotional_state_end',
            ...
            'guiding_questions' => [
                  "Describe what happened to the survivor in the survivor's own words",
                  '',
                  "Describe what happened in the survivor's own words (do not suggest).",
                  '',
                  ...
                  "When did it occur?",
                  '',
                  "What prompted her to seek services?",
                  '',
                  "What are her main concerns?",
                  '',
                  "What does she want help with?"
            ].join("\n")),
  Field.new('name' => 'assessment_main_concerns_header',
            'show_on_minify_form' => true,
            'mobile_visible' => true,
            'type' => 'separator',
  ...
  Field.new('name' => 'assessment_current_situation',
            ...
            'guiding_questions' => [
                  ...
                  '',
                  'Has survivor sought help previously and/or already received care and treatment? Does the survivor express any current or past suicidal thoughts? (If so, follow the Suicide Risk Assessment Protocol)'].join("\n")),
  Field.new('name' => 'assessment_safety_needs',
            ...
            'guiding_questions' => [
              'Safety needs',
              '',
              'Will the survivor be in immediate danger when she leaves here? How safe does the survivor feel at home? (Note: caseworker can use tools such as safety scale to help determine this). Has the survivor ever tried to get help from anyone else? Has the survivor ever tried to leave? Are aspects about the perpetrator’s profile or the type of violence that place the survivor in immediate danger?'
            ].join("\n")),
  Field.new('name' => 'assessment_health_needs',
            ...
            'guiding_questions' => [
              'Health needs',
              '',
              'Does the client require and/or want medical attention?',
              '',
              'Did the last incident occur within the past 120 hours?',
              '',
              'Would the survivor like to know more about medication and exam options?',
              '',
              'Is the survivor complaining of physical pain and injury, or bleeding or discharge?'
            ].join("\n")),
  ...
  Field.new('name' => 'assessment_legal_needs',
            ...
            'guiding_questions' => [
                  ...
                  '',
                  'Does the survivor want more information about how her legal rights and/or options for taking her case through the formal justice system, or the traditional /informal justice system? Does the survivor understand the differences between how a case would be handled through traditional vs. formal justice mechanisms?'].join("\n")),
  Field.new('name' => 'assessment_material_needs',
            ...
            'guiding_questions' => [
              ...
              '',
              'Does the survivor have access to income?',
              '',
              'Does the survivor have access to food, clothes, phone credit, transportation, etc.?',
              '',
              "What are the survivor's sources of support, including family and community?",
              '',
              "Is the survivor's lack of income impacting her ability to be safe?",
              '',
              "Is the survivor's lack of (or access to) income putting her at risk for violence?"
            ].join("\n")),
