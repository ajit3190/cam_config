...
PrimeroModule.create_or_update!(
  ...
  form_sections: FormSection.where(unique_id: %w[incident_record_history incident_form killing_violation_wrapper maiming_violation_wrapper
                                                 recruitment_violation_wrapper sexual_violence_violation_wrapper attack_on_violation_wrapper
                                                 ...
                                                 maiming recruitment sexual_violence attack_on military_use denial_humanitarian_access
