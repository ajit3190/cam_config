...
interview_details_fields = [
  ...
  Field.new('name' => 'case_eligibility_criteria',
            'type' => 'radio_button',
            'display_name_en' => 'Case meets eligibility criteria?',
            'option_strings_source' => 'lookup lookup-yes-no'),
  Field.new('name' => 'source_identification_referral',
            'type' => 'select_box',
            'display_name_en' => 'Source of identification/referral',
            'option_strings_text_en' => [
              { id: 'child_family_member', display_text: 'Child / family member' },
              { id: 'community_members_cpc', display_text: 'Community members / CPC' },
              { id: 'school_personnel', display_text: 'School personnel' },
              { id: 'health_personnel', display_text: 'Health personnel' },
              { id: 'population_registration_services', display_text: 'Population registration services' },
              { id: 'law_enforcement_agencies', display_text: 'Law enforcement agencies' },
              { id: 'humanitarian_agencies', display_text: 'Humanitarian agencies' }
            ].map(&:with_indifferent_access)),
  Field.new('name' => 'consent_form_completed',
            'type' => 'radio_button',
            'display_name_en' => 'Consent and Assent form completed?',
            'option_strings_source' => 'lookup lookup-yes-no')
]
