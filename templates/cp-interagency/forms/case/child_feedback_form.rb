...
child_feedback_form_fields = [
  Field.new(name: 'child_feedback_date_completed',
            type: 'date_field',
            display_name_en: 'Date form completed'),
  Field.new(name: 'child_feedback_separator_consent',
            type: 'separator',
            display_name_en: 'Consent and Assent',
            guiding_questions_en: [
              'Sample script: "I would like to speak with you regarding how the caseworker has worked with you and your family.',
  ...
  Field.new(name: 'child_feedback_interview_subject',
            type: 'select_box',
  ...
  Field.new(name: 'child_feedback_consent_source_other',
            type: 'text_field',
            display_name_en: 'If Other, please specify'),
  Field.new(name: 'child_feedback_consent',
            type: 'tick_box',
            display_name_en: 'Permission has been given by the child to collect his/her feedback on the case management process.',
            tick_box_label_en: 'Yes'),
  Field.new(name: 'child_feedback_consent_caregiver',
            type: 'tick_box',
            display_name_en: 'Permission has been given by the caregiver to collect feedback on the case management process from his/her child.',
            tick_box_label_en: 'Yes',
            help_text_en: 'Only complete where possible and if appropriate'),
  Field.new(name: 'child_feedback_consent_date',
            type: 'date_field',
            display_name_en: 'Date of Consent / Assent'),
  Field.new(name: 'child_feedback_separator_questions',
            type: 'separator',
  ...
  Field.new(name: 'child_feedback_services_discovery',
            type: 'select_box',
            display_name_en: "How did you find out about [insert case management agency name]'s case management services?",
            option_strings_text_en: [
              ...
              { id: 'parents', display_text: 'Parents' },
  ...
  Field.new(name: 'child_feedback_services_discovery_other',
            type: 'text_field',
            display_name_en: 'If Other, please specify'),
  Field.new(name: 'child_feedback_help_asked',
            type: 'select_box',
            display_name_en: 'Before you started working with the caseworker, were you asked whether you wanted to be helped in this way?',
            option_strings_text_en: [
              { id: 'yes', display_text: 'Yes' },
              { id: 'no', display_text: 'No' },
              { id: 'unknown', display_text: 'Unknown' }
            ].map(&:with_indifferent_access)),
  Field.new(name: 'child_feedback_help_asked_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_expectations',
            type: 'select_box',
            multi_select: true,
  ...
  Field.new(name: 'child_feedback_expectations_other',
            type: 'text_field',
            display_name_en: 'If Other, please specify'),
  Field.new(name: 'child_feedback_expectations_received',
            type: 'select_box',
  ...
  Field.new(name: 'child_feedback_expectations_received_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_process_plan',
            type: 'select_box',
  ...
  Field.new(name: 'child_feedback_process_plan_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_process_connect',
            type: 'select_box',
  ...
  Field.new(name: 'child_feedback_process_connect_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_process_consent',
            type: 'select_box',
  ...
  Field.new(name: 'child_feedback_process_consent_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_process_closure',
            type: 'select_box',
            display_name_en: "Did you make the decision to stop [insert agency name]'s case management services together with the caseworker?",
            option_strings_text_en: [
              { id: 'yes', display_text: 'Yes' },
              { id: 'no', display_text: 'No' },
              { id: 'unknown', display_text: 'Unknown' }
            ].map(&:with_indifferent_access)),
  Field.new(name: 'child_feedback_process_closure_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_questions_ii',
            type: 'separator',
  ...
  Field.new(name: 'child_feedback_ii_explanation',
            type: 'select_box',
  ...
  Field.new(name: 'child_feedback_ii_explanation_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_ii_listening',
            type: 'select_box',
            display_name_en: 'The caseworker always asked for and listened to my views, opinions and feelings.',
            help_text_en: 'Choose a number between 1 and 10',
            option_strings_source: 'lookup lookup-number-range-one-to-ten'),
  Field.new(name: 'child_feedback_ii_listening_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_ii_pressured',
            type: 'select_box',
            display_name_en: 'I often felt pressured by the caseworker to make a decision or to do something I did not wish to do.',
            help_text_en: 'Choose a number between 1 and 10',
            option_strings_source: 'lookup lookup-number-range-one-to-ten'),
  Field.new(name: 'child_feedback_ii_pressured_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_ii_followup',
            type: 'select_box',
            display_name_en: 'The caseworker followed-up and did the things s/he said s/he would do.',
            help_text_en: 'Choose a number between 1 and 10',
            option_strings_source: 'lookup lookup-number-range-one-to-ten'),
  Field.new(name: 'child_feedback_ii_followup_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_ii_visits',
            type: 'select_box',
            display_name_en: 'The caseworker only visited me rarely.',
            help_text_en: 'Choose a number between 1 and 10',
            option_strings_source: 'lookup lookup-number-range-one-to-ten'),
  Field.new(name: 'child_feedback_ii_visits_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_ii_support',
            type: 'select_box',
            display_name_en: 'The support the caseworker provided to me and my family was useful.',
            help_text_en: 'Choose a number between 1 and 10',
            option_strings_source: 'lookup lookup-number-range-one-to-ten'),
  Field.new(name: 'child_feedback_ii_support_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_ii_improvement',
            type: 'select_box',
            display_name_en: 'Since I have been working with the caseworker my situation has improved.',
            help_text_en: 'Choose a number between 1 and 10',
            option_strings_source: 'lookup lookup-number-range-one-to-ten'),
  Field.new(name: 'child_feedback_ii_improvement_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_ii_satisfaction',
            type: 'select_box',
            display_name_en: 'Overall, I am very satisfied with the support provided by the caseworker.',
            help_text_en: 'Choose a number between 1 and 10',
            option_strings_source: 'lookup lookup-number-range-one-to-ten'),
  Field.new(name: 'child_feedback_ii_satisfaction_details',
            type: 'textarea',
            display_name_en: 'Please provide details'),
  Field.new(name: 'child_feedback_final_question',
            type: 'select_box',
  ...
  Field.new(name: 'child_feedback_final_question_details',
            type: 'textarea',
            display_name_en: 'Please provide details')
]
...
FormSection.create_or_update!(
  ...
  'editable' => true,
  :fields => child_feedback_form_fields,
  'name_en' => 'Child Feedback',
  'description_en' => 'Child Feedback'
)
